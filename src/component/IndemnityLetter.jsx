      ...
      >
        ...
        <div className="page">
          ...
          <Typography variant="body1" sx={{ marginBottom: "1rem" }}>
            ...
            JATMIT India Private Limited towards the following points:
          </Typography>
          ...
          <TableContainer>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell>
                    JATMIT India Private Limited is providing us with a platform
                    as an enabler through which we can transfer/receive/top up
                    the money through various methods like
                    UPI/IMPS/RTGS/Cash/Payment Gateway etc from one person to
                    another(P2P and P2M) against a separate consideration.
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                ...
                <TableRow>
                  <TableCell>
                    ...
                    transaction with end customers to the JATMIT India Private
                    Limited at JATMIT India Private Limited discretion.
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                ...
                <TableRow>
                  <TableCell>
                    ...
                    JATMIT, assuring that every sender or receiver or both only
                    after giving their full consent will use this platform for
                    transfer/receive/topup the money through various methods
