      ...
      >
        <Page size="A4" style={styles.page}>
          ...
          <Typography variant="body1" paragraph>
            ...
            registered office at 907A BLOCK NO 6,Circular Road,MDSD GIRLS
            COLLEGE ROAD,Old Town,Ambala,Haryana,134003.
          </Typography>
          <Typography variant="body1" paragraph>
            (Hereinafter referred to as “JATMIT” which expression shall, unless
            repugnant to the context or meaning thereof, include their
          ...
          <Typography variant="body1" paragraph>
            The JATMIT and the Retailer are herein collectively referred to as
          ...
          <Typography variant="body1" paragraph>
            ...
            Agreement, JATMIT hereby appoints the Retailer on a non-exclusive
          ...
          <Typography variant="body1" paragraph>
            The Retailer may describe himself as JATMIT’s authorised Retailer,
            but must not hold itself out as being entitled to bind JATMIT in any
            way.
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            Upon expiry, the Agreement may be renewed at JATMIT’s option, on
            mutually agreed terms, provided that JATMIT informs the Retailer one
            month prior to the completion of the Term.
          </Typography>
        </Page>
        <Page size="A4" style={styles.page}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              During the Term, the Retailer shall render to JATMIT services as
              defined in Annexure-I. JATMIT reserves the right to modify, alter,
              or amend the list of Services, and the Retailer agrees to be bound
              by any such changes.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              Plan for sourcing retailers for JATMIT. JATMIT reserves the right
              to appoint additional Distributors or terminate this Agreement if
              the Distributor fails to meet the agreed minimum targets.
            </Typography>
            <Typography variant="body1" paragraph>
              The Distributor is solely responsible for managing credit
              transactions with the retailers in its Territory, and JATMIT is
          ...
          <section>
            ...
            <Page size="A4" style={styles.page}>
              <Typography variant="body1" paragraph>
                ...
                deposit shall be non-interest bearing and shall be refunded at
              ...
              <Typography variant="body1" paragraph>
                The Retailer acknowledges that the JATMIT may reject the deposit
            ...
            <Typography variant="body1" paragraph>
              Retailer agrees and acknowledges that the JATMIT shall not be
            ...
            <Typography variant="body1" paragraph>
              All the amount due to JATMIT under this Retailer Agreement,
              ...
              Annexure-II. Retailer agrees and acknowledges that the JATMIT may,
              by prior written notice of two business days, modify any of the
              details mentioned in Annexure-II and the Retailer shall be bound
              by all such modifications
            </Typography>

            <Typography variant="body1" paragraph>
              Retailer acknowledges and agrees that JATMIT strictly prohibits
            ...
            <Typography variant="body1" paragraph>
              ...
              be specified by the JATMIT, from time to time and published on
              JATMIT’s portal. All the amounts paid by way of the commission
              ...
              applicable; JATMIT shall debit the account of the Retailer to the
              extent of such taxes.
            </Typography>
            <Typography variant="body1" paragraph>
            ...
            <Typography variant="body1" paragraph>
              ...
              JATMIT assumes no responsibility for the tax compliance of the
              Retailer.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              The Retailer agrees and authorizes JATMIT to impose cash deposit
            ...
            <Typography variant="body1" paragraph>
              ...
              responsible; and in such event, JATMIT is authorized to
              immediately deactivate the account of Retailer without any prior
              notice. JATMIT shall not be held responsible for any consequences
              that arise out of any unauthorized use of its platform in any
              manner.
            </Typography>

            <Typography variant="body1" paragraph>
              The Retailer agrees and authorizes JATMIT to freeze its account or
              account of its Retailer in the event JATMIT receives any complaint
              from any relevant statutory or non-statutory authority or any
              government department or agency. The Retailer further agrees and
              authorizes JATMIT to withdraw the disputed amount along with the
              anticipated penalty from the such frozen account.
            </Typography>

            <Typography variant="body1" paragraph>
              Retailer agrees and acknowledges that all the sales/ receipts of
              the Retailer regarding the JATMIT shall be immediately Deposit or
              transfer of the funds into the designated Bank Accounts of the
              JATMIT and shall get limit from the Company/ JATMIT thereafter.
              The Retailer shall ensure that the working limit in the portal by
              JATMIT against the cash deposit or funds transfer is made
              available to the Retailer immediately. The Retailer shall inform
              to the Company/ JATMIT in predefined format, if the Retailer fails
              to inform the same within seven calendar days the amount will be
              forfeit by the Company/ JATMIT. Retailer may deposit such cash
              self or via its employee or agent or any authorized person into
              the designated Bank Accounts of the JATMIT.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              of such office to JATMIT.
            </Typography>
            <Typography variant="body1" paragraph>
              JATMIT may, at its discretion, provide advice to the Retailer in
        ...
        <section>
          ...
          <Typography variant="body1" paragraph>
            ...
            misuse of any data related to clients of JATMIT from its office.
          </Typography>
          <Typography variant="body1" paragraph>
            The Retailer agrees and acknowledges that JATMIT will not have any
        ...
        <Page size="A4" style={styles.page}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              JATMIT hereby grants the Retailer a limited, non-exclusive,
            ...
            <Typography variant="body1" paragraph>
              ...
              JATMIT. Further, the Retailer shall ensure that the third-party
            ...
            <Typography variant="body1" paragraph>
              ...
              Agreement in any way limit the JATMIT’s rights over its
              ...
              the intellectual property shall be exclusive of DIGIVOUCHER
              without any compensation to anyone.
            </Typography>
            <Typography variant="body1" paragraph>
              The Retailer shall not use the Software of the JATMIT in any
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              That Retailer agrees and acknowledges that the JATMIT has a
        ...
        <Page size="A4" style={styles.page}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              in competition with any business carried by JATMIT at the relevant
              time, whether in India or abroad, or 2.) engage in any business
              that is similar to or in competition with any business carried on
              by the JATMIT at the relevant time.
            </Typography>
            <Typography variant="body1" paragraph>
              During the Term of Retailer Agreement, the Retailer shall not
              either directly or indirectly solicit any employee of JATMIT for
              employment, induce or attempt to induce any such employee to
              terminate or breach his or her employment agreement with JATMIT,
              or hire any such employee or associate with any such employee,
              either during the course of their employment with JATMIT or after
              the termination of their employment with the JATMIT.
            </Typography>
            <Typography variant="body1" paragraph>
              ...
              of JATMIT to cease doing business or not to do business, in whole
              or in part of with JATMIT, or solicit, cause in any part or
              knowingly encourage any existing or potential clients or customers
              of JATMIT to do business with any person other then JATMIT, or
              associate with any prospective clients or customers while they
              continue to be clients or customers of JATMIT.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              The Retailer shall only market and promote Services of JATMIT, as
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              JATMIT may terminate this Retailer Agreement of the Retailer with
              immediate effect, if a. in the opinion of JATMIT, Retailer is not
              the fit person to perform Services under the provision of Retailer
              Agreement. b. Retailer fails to deposit the proceeds of sale/
              receipts made by the Retailer or its retailers to JATMIT on a
              daily basis and perpetual basis. c. Retailer becomes the subject
              of a voluntary petitioner in bankruptcy or any voluntary
              ...
              directions issued by the JATMIT under the provision of this
              Retailer Agreement. Notwithstanding anything to the contrary
              herein, JATMIT may terminate this Retailer Agreement without
              notice.
            </Typography>
            <Typography variant="body1" paragraph>
              Retailer may terminate this Retailer Agreement with written notice
              of 60 (sixty) days to JATMIT.
            </Typography>
          </section>
          <section>
            <Typography
            ...
            <Typography variant="body1" paragraph>
              ...
              intellectual property, Software provided by the JATMIT and shall
              immediately hand over all copies or documents of such intellectual
              property to JATMIT. b. immediately return to JATMIT all
              ...
              provide remote access to JATMIT to disable any Software that
              JATMIT has installed with the Retailer. d. immediately remove all
              sign board, banners, and glowboards of JATMIT from its offices and
              also all such materials which will indicate any association with
              JATMIT. e. immediately ceases to promote, market or advertise
              JATMIT or its products/services. f. immediately clear all dues
              within the period of 7 days from the date of termination.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              The Retailer shall indemnify itself and hold JATMIT and all its
            ...
            <Typography variant="body1" paragraph>
              ...
              JATMIT shall not be liable to the Retailer for any incidental,
              indirect, consequential damages, or loss of revenue or business
              opportunities.
            </Typography>

            <Typography variant="body1" paragraph>
              The Retailer shall ensure that the JATMIT platform or services are
              not used for money laundering and comply with Anti-Money
            ...
            <Typography variant="body1" paragraph>
              ...
              use of JATMIT Platform or services for the following:
              <ul>
        ...
        <Page size="A4" style={styles.page}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              JATMIT, and nothing in this Retailer Agreement creates or shall be
              deemed to create the relationship of partners, joint venture,
        ...
        <Page size="A4" style={styles.page}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              applicable laws. The Retailer shall permit JATMIT to inspect all
            ...
            <Typography variant="body1" paragraph>
              ...
              proper due diligence as instructed by JATMIT.
            </Typography>
            <Typography variant="body1" paragraph>
              During the Term and up to sixty days after the termination of this
              Retailer Agreement, JATMIT may carry out an audit to determine
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              prior written permission is obtained from JATMIT.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              The Retailer agrees that JATMIT may communicate with them via
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              No legal action or suit can be initiated against JATMIT without
