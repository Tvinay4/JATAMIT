        ...
        <div>
          <div>
            <div>
              ...
              <p className="landing-bg_para">
                These Terms are a binding agreement between you and JATMIT .
                These Terms are in addition to and not in derogation of any
                other terms stipulated by JATMIT from time to time. In case of
                ...
                <strong>“our”</strong> to refer to JATMIT and the terms
                <strong>“you”</strong> and <strong>“your”</strong> to refer to
                you, the User of the Platform. Both JATMIT and the User are
              ...
              <div className="landing-bg_para">
                ...
                <p className="landing-bg_para">
                  JATMIT ’s services are available to anyone having a valid
                  ...
                  service by JATMIT shall not be eligible to avail services from
                  JATMIT . Users shall not impersonate any person or entity, or
              ...
              <div className="landing-bg_para">
                ...
                <p className="landing-bg_para">
                  ...
                  and financial information of JATMIT or of any of its
                  ...
                  otherwise disclosed by JATMIT to the User any information
              ...
              <div className="landing-bg_para">
                ...
                <p>
                  ...
                  the Services provided by JATMIT :
                </p>
              </div>
              ...
              <div className="landing-bg_para">
                ...
                <div className="landing-bg_para">
                  ...
                  identifies a Users’ account with JATMIT through which JATMIT
                  services are dispensed (“
                  <strong>Account</strong>
                  ”). JATMIT encourages Users to choose a strong password to
                  protect their Account. It is advised that Users do not share
                  their password with anyone or write it down. Neither JATMIT
                ...
                <div className="landing-bg_para">
                  ...
                  pursuant to provision of JATMIT ’s services, and information
                ...
                <div className="landing-bg_para">
                  ...
                  to be overly inactive, the Account may be reclaimed by JATMIT
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="landing-bg_para">
                    <div className="landing-bg_para">
                      JATMIT may send transactional or non-transactional
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="landing-bg_para">
                    <div className="landing-bg_para">
                      In no event will JATMIT or its directors, agents,
                      ...
                      <p className="mt-2">
                        ...
                        entered by a User with JATMIT ,
                      </p>
                      <p>
                        b) &nbsp; JATMIT ’s services, the Site or any Reference
                        site, or
                      </p>
                      <p>
                    ...
                    <div className="landing-bg_para">
                      Users acknowledge and agree that JATMIT has offered its
                    ...
                    <div className="landing-bg_para">
                      ...
                      JATMIT , and that the warranty, disclaimers, and the
                      limitations of liability set forth herein form an
                      essential basis of the bargain between Users and JATMIT .
                      JATMIT would not be able to provide the services to Users
                      on an economically reasonable basis without these
                      limitations.
                    </div>
                    <div className="landing-bg_para">
                      Users understand that JATMIT or the Service Providers may
                    ...
                    <div className="landing-bg_para">
                      User further acknowledge that as a security measure JATMIT
                    ...
                    <div className="landing-bg_para">
                      As a risk management tool, JATMIT and/or the Service
                      Providers reserve the right to limit or restrict
                      transaction size, amount and/or monthly volume at any
                      time. JATMIT will consider a variety of factors in making
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="landing-bg_para">
                    <div className="landing-bg_para">
                      If JATMIT is intimated, by the bank, that a customer has
                      reported an unauthorized debit/chargeback of the
                      customer’s Payment Instrument (“Fraudulent Transaction”),
                      the User shall be notified by JATMIT . The User shall be
                    ...
                    <div className="landing-bg_para">
                      ...
                      <p>
                        ...
                        entitled to order the JATMIT to affect a reversal of the
                    ...
                    <div className="landing-bg_para">
                      JATMIT shall also be entitled to suspend the settlement of
                    ...
                    <div className="landing-bg_para">
                      ...
                      JATMIT incurring the charge stipulated in clause 1.8(iii),
                      if the available Transaction Amounts are insufficient for
                      deduction of the Chargeback Amount, then JATMIT is
                      entitled to issue a debit note seeking reimbursement of
                      the Chargeback Amount from the User. The User shall
                      reimburse the Chargeback Amount within three (3) working
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="landing-bg_para">
                    ...
                    <div className="landing-bg_para">
                      ...
                      the account balance maintained by the Users on JATMIT
                      Platform shall be non-interest bearing and shall be
                      forfeited by JATMIT if found lying unused for more than
                      365 days.
                    </div>
                  </div>
                </div>
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="landing-bg_para">
                    ...
                    <div className="landing-bg_para">
                      ...
                      that is provided by JATMIT . It shall not use any
                    ...
                    <div className="landing-bg_para">
                      ...
                      JATMIT against any and all losses, claims, liabilities,
                ...
                <div className="landing-bg_para">
                  <u>INDEMNIFICATION.</u>
                  User agrees to indemnify, save, and hold JATMIT , its
                  ...
                  which may be threatened or brought against JATMIT , and also
                  ...
                  <div className="landing-bg_para">
                    <div className="landing-bg_para">
                      Users’ use or misuse of JATMIT ’s services or of the
                      Site/application
                    </div>
                    <div className="landing-bg_para">
                    ...
                    <div className="landing-bg_para">
                      ...
                      which JATMIT may be required to become party or to which
                      JATMIT may be subjected by any person including any
                    ...
                    <div className="landing-bg_para">
                      ...
                      its obligations in the Applicable Agreement with JATMIT ,
                    </div>
                    <div className="landing-bg_para">
                      all liability, claims, damages, costs, expenses suffered
                      or incurred by JATMIT as a result of any act or violation
                      by User under Section 269ST of the Income Tax Act, 1961
                      while acting as collection agent of the Company.
                    </div>
                    <div className="landing-bg_para">
                      JATMIT reserves the right, at User’s expense, to assume
                      the exclusive defense and control of any matter, including
                      rights to settle, for which concerned User is required to
                      indemnify JATMIT . The User agrees to cooperate with
                      JATMIT ’s defense and settlement of these claims. JATMIT
                ...
                <div className="landing-bg_para">
                  ...
                  JATMIT and its officers, directors, employees, and agents
                  ...
                  obtained by a User from JATMIT or through JATMIT ’s services
                  or the Site will create any warranty not expressly stated
                  herein. JATMIT does not authorize anyone to make any warranty
                  on its behalf and Users should not rely on any such statement.
                  Users acknowledge that JATMIT SERVICES is a reseller and is
                  not liable for any third-party seller’s obligations. It is
                  ...
                  generally. JATMIT does not warrant that its services will be
                  uninterrupted, or free of errors, viruses or other harmful
                  components, and that any of the foregoing defects will be
                  corrected. JATMIT ’s services and the Site and any data,
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="custom-list points-alpha mt-3">
                    <div className="landing-bg_para">
                      JATMIT ’s services and the Site are owned and operated by
                      JATMIT and/or third-party licensors. The visual
                      ...
                      JATMIT ’s services and the Site provided by JATMIT (the{" "}
                      <strong> “Materials”</strong>) are protected by Applicable
                      Law. As between User and JATMIT , all Materials and JATMIT
                      ’s Intellectual Property are the property of JATMIT and/or
                      third-party licensors or suppliers. User agrees not to
                      remove, obscure, or alter JATMIT or any third party's
                      copyright, patent, trademark, or other proprietary rights
                      notices affixed to or contained within or accessed in
                      conjunction with or through JATMIT ’s services. Except as
                      expressly authorized by JATMIT , the User agrees not to
                      ...
                      of the Materials or JATMIT ’s Intellectual Property.
                    </div>
                    <div className="landing-bg_para">
                    ...
                    <div className="landing-bg_para">
                      If Users’ have comments regarding JATMIT 's services and
                      the Site or ideas on how to improve it, please write to
                      our 24x7 Helpdesk at {getFirmEmail()}. Please note that by
                      doing so, concerned User hereby irrevocably assign to
                      JATMIT , and shall assign to JATMIT , all right, title and
                ...
                <div className="landing-bg_para">
                  <u>MODIFICATION.</u>
                  JATMIT reserves the right to change, modify, add, or remove
                ...
                <div className="landing-bg_para">
                  <u>FORCE MAJEURE .</u>
                  JATMIT shall not be liable for failure to perform its
                ...
                <div className="landing-bg_para">
                  ...
                  <div className="custom-list points-alpha mt-3">
                    ...
                    <div className="landing-bg_para">
                      ...
                      but may be assigned by JATMIT without restriction. Any
                    ...
                    <div className="landing-bg_para">
                      <u>NOTICE</u>. JATMIT may provide Users with notices and
                    ...
                    <div className="landing-bg_para">
                      <u>WAIVER</u>. The failure of JATMIT to exercise or
                      ...
                      effective only if in writing and signed by JATMIT .
                    </div>
                    ...
                    <div className="landing-bg_para">
                      ...
                      formal business organization of any kind. JATMIT SERVICES
                      and the User shall be independent contractors with each
                      other for all purposes at all times and neither Party
                      shall act as or hold itself out as an agent or
