  ...
  <Typography component="span" variant="h5" fontWeight="bold" color="#0F6E0A">
    Fast Transactions & Rewards
        ...
        <Stack spacing={1.5} sx={{ mt: 4 }}>
          {[
            { text: "Mobile Recharge: Prepaid & Postpaid recharges in seconds" },
            { text: "DTH Recharge: Quick TV subscription renewal" },
            { text: "Data Plans: Get the best internet packs instantly" },
            { text: "Broadband: Stay connected with no interruptions" },
            { text: "Insurance Payments: Easy renewal and coverage" },
          ].map((item, index) => (
...
export default LandingPageLoans