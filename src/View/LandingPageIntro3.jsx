...
import { Irctc_img, lp_illustration } from "../iconsImports";
    ...
    >
      <Container maxWidth="xl">
        ...
        >
          <Grid
            item
            md={env === "JATMIT" || env === "PaisaKart" ? 6 : 12}
            sm={12}
          >
            <Box
              sx={{
            ...
            >
              ...
              {process.env.REACT_APP_TITLE === "MoneyOddr" ? (
                ...
                <div>
                  ...
                  >
                    {/* <b>{env === "JATMIT" ? "JATMIT" : "PaisaKart"}</b> */}
          ...
          {env !== "MoneyOddr" && (
            ...
            >
              <img
                ...
                style={{
                  backgroundColor: getEnv() === "JATMIT" ? "#fff" : "",
                  borderRadius: getEnv() === "JATMIT" ? "50%" : "",
                }}
              />
            </Grid>
          )}
