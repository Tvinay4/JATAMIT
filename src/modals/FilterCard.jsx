...
const FilterCard = ({
  ...
  function createFilterQuery(
    ...
    if (user_id) {
      filter = filter + (filter ? "&" : "") + "user_id=" + (user_id && user_id);
    }
  ...
  const clearHooks = () => {
    ...
    setQuery(
      location.pathname === "/customer/cred-req" ||
        ...
        location.pathname === "/ad/cred-req" ||
        location.pathname === "/ad/cred-req" ||
        location.pathname === "/asm/cred-req" ||
        location.pathname === "/zsm/cred-req"
        ? "status=ALL"
        : ""
    );
  };
          ...
          >
            ...
            >
              ...
              >
                ...
                <MenuItem sx={{ fontSize: "13px" }} value="REFUND">
                  REFUND
                </MenuItem>
              </TextField>
            </FormControl>
